      ...
      <div className="inner md">
        ...
        <div className="login-bottom-con">
          <ul className="btn__group btn__group--sns btn__group--center">
            <li>
              <button type="button" className='btn btn--kakao'>카카오로 회원가입</button>
            </li>
            <li>
              <button type="button" className='btn btn--naver'>네이버로 회원가입</button>
            </li>
            <li>
              <button type="button" className='btn btn--google'>구글로 회원가입</button>
            </li>
          </ul>

          <div className="sign-up-btn">
            <button type="button" className='btn btn--arrow btn--arrow--next'>이메일로 회원가입</button>
          </div>
        </div>
