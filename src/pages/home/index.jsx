    ...
    <div className="ss-wrap ss-wrap__home">
        ...
        <Swiper slidesPerView={2} spaceBetween={20}>
          <SwiperSlide>
            <div className="family-content__card">
              <div
                style={{
                  backgroundImage: `url('/src/assets/images/samples/sample8.jpg')`,
                }}></div>
      ...
      <section className="main-section event mb-65">
        ...
        <Swiper modules={[Pagination]} pagination={{ clickable: true }}>
          <SwiperSlide style={{ backgroundColor: '#f6b34e' }}></SwiperSlide>
          <SwiperSlide style={{ backgroundColor: '#ff8f4e' }}></SwiperSlide>
          <SwiperSlide style={{ backgroundColor: '#f6b34e' }}></SwiperSlide>
          <SwiperSlide style={{ backgroundColor: '#ff8f4e' }}></SwiperSlide>
        </Swiper>
      </section>
          ...
          <SwiperSlide>
            <div className="gallery__item">
              <div
                ...
                style={{
                  backgroundImage: `url('/src/assets/images/samples/sample5.jpg')`,
                }}></div>
          ...
          <SwiperSlide>
            <div className="gallery__item">
              <div
                className="gallery__thumbnail"
                style={{
                  backgroundImage: `url('/src/assets/images/samples/sample6.jpg')`,
                }}></div>
              <div className="gallery__info">
                <span>2023.05.20</span>
                <span>by 새식이</span>
          ...
          <SwiperSlide>
            <div className="gallery__item">
              <div
                className="gallery__thumbnail"
                style={{
                  backgroundImage: `url('/src/assets/images/samples/sample7.webp')`,
                }}></div>
              <div className="gallery__info">
                <span>2023.05.20</span>
                <span>by 새식이</span>
